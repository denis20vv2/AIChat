...
('msg2', 'AI replied message', 'user1', 'group1', 'user', 'ai_reply_2', CURRENT_TIMESTAMP),
('msg3', 'Hello, World!', 'user1', 'group1', 'user' , 'ai_reply_3', CURRENT_TIMESTAMP),
('msg4', 'AI replied message', 'user2', 'group2', 'user', 'ai_reply_4', CURRENT_TIMESTAMP);
